...
public class Client  {
	 ...
	 */
	class ListenFromServer extends Thread { //here we have used thread to achieve parallelism and do multiple tasks together

		public void run() {
			while(true) {
				try {
					// read the message form the input datastream
					String msg = (String) sInput.readObject(); //basically this module would read as much message is being parsed from the input stream
					// print the message
					System.out.println(msg);
					System.out.print("> ");
				}
